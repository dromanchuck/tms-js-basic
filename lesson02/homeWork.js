...
let precent = 10;
let year = 5;
let overpayment = credit / 100 * precent * year;
...
let minutes = 60;
let second = 60;
let week = second * minutes * hour * day;
console.log(week);
alert('Сегодня 23.06.2020 узнал, что количество секунд в одной неделе составляет ' + week);
