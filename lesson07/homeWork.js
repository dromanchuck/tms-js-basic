...
testToFuncMinArg('Первый тест',makePassword('LowlyYl'), true);
testToFuncMinArg('Второй тест', makePassword('LowlyYlL'), false);
testToFuncMinArg('Третий тест', makePassword('password'), false);
