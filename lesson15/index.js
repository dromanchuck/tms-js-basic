...
//localStorage
let todos = Local.todos || []; // класс local c методом todos(геттер todos получает из storage obj) или пустой массив
...
// добавляет button-active если в импуте более 2 символов и запускае функцию addToList
...
function addToList(text) {
  ...
  Local.todos = todos; // добавляет данные в storage
