...
// //createElem
// let inputToTime = document.createElement('input') 
...
// container.append(inputToTime, button);
...
// //event
// button.onclick = () => {
//     if((inputToTime.value / 1) === Number(inputToTime.value)) {
//         setTimeout(beep, (inputToTime.value * 60000));
