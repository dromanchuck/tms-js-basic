...
//  let inputReminders = document.createElement('input');
//  let buttonReminders = document.createElement('button')

//  buttonReminders.innerHTML = 'Create Reminder';

//  document.body.append(divContainer);

//  divContainer.append(inputReminders, buttonReminders)

//  inputReminders.setAttribute('type','number');
//  inputReminders.setAttribute('placeholder','Количество минут');
...
// buttonReminders.onclick = () =>{

//     if(inputReminders.value < 0){
//         alert('Не существует отрицательных минут')
//     }else{
//         setTimeout(() => soundTimer(), inputReminders.value * 60000)
//     }
